...
% ytakei@caltech.edu
    ...
    % added for the 100k RNA and DNA DAPI alignment
    if divideIms
        [RNAIms4, ~] = imdivideby4(RNAIms{sizeCRNA});
        [DNAIms4, ~] = imdivideby4(DNAIms{sizeCDNA});
        tform2ref = grabtform(RNAIms4, DNAIms4,initialRadius,numIterations);
    else
        tform2ref = grabtform(RNAIms{sizeCRNA}, DNAIms{sizeCDNA},initialRadius,numIterations);
    end
