function [pointsch, offsets, corrpoints] = seqfishtformalign_v3(experimentDir, experimentLabel, ...
    ...
    while(exist(offsetsPath, 'file') ~= 2)
        % get offsets
        %system(pythonCommand); % this was probably an unnecessary duplication
        offsetsPath = getfile(offsetsDir, offsetsName, 'match');
    ...
    [pointsch, offsets] = alignpointswrapper_v4(chArray, pointsPath, offsetsPath, ...
