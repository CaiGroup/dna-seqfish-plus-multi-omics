function [pointsch, offsets, corrpoints] = seqfishtformalign_v2rna(experimentDir, experimentLabel, ...
    ...
    [pointsch, offsets] = alignpointswrapper_v3rna(chArray, pointsPath, offsetsPath, ...
