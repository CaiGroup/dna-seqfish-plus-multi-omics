function I = seqfishprocess_initialpoints_v3IFext(experimentDir, experimentName, experimentLabel, ...
    position, folderArray, superres, chaTform, filtersigma, numCh, experimentDir_ref, back, edge)
    ...
    I = outputprocessimages_chTcorrectedIFext_v2(experimentDir, ...
        position, folderArray, numCh, typedots, superres, [], [], threshold, ...
        refposition, experimentLabel, [], thresholdadjust, filtersigma, chaTform, back, edge);
