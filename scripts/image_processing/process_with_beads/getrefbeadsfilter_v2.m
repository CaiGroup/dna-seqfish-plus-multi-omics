function [chaTform, refPointsAligned, intensity, firstThreshold, numRefPoints] ...
    = getrefbeadsfilter_v2(experimentDir, position, beadfoldername, roimask, chaTformGlobal, varargin) 
...
%addpath('C:\github\streamline-seqFISH\src\FindThreshold\', '-end');
    ...
    for ch = 1:numCh
        beadImsTemp{ch} = imwarp(beadImsTemp{ch}, chaTformGlobal{ch}, 'OutputView', imref3d(size(beadImsTemp{ch})));
    end
