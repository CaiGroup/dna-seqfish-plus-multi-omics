...
experimentDir = 'H:\Yodai\100k\2021-05-20-cerebellum-IF-plate2-rep1';
experimentName = '2021-05-20-cerebellum-IF-final';
experimentLabel = experimentName;

% original DNA seqFISH analysis folder
experimentDir_ref = 'H:\Yodai\100k\2021-05-16-cerebellum-DNAfull-rep1';
experimentLabel_ref = '2021-07-06-cerebellum-100k-rep1-final';
% decoded points folder
save_folder = 'I:\OneDrive - California Institute of Technology\Long Cai - 1\100k\LC1-100k-002-cerebellum-rep1\output';
save_name = 'LC1-100k-002-002-2021-07-17-cerebellum-100k-rep1-output-finalpoints-paints-decoded-onoff-chAll-pos';

posArray = 0;%0:2; % for decoding. needs Pos0 anyway. Don't start from Pos1 or later.
