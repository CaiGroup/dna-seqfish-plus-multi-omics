function [chaTformInitial, chaTformFinal, physicaltform, refPointsAlignedInitial, ...
    refInitialSaveName] = debugbeads_cellnum_v2(experimentDir, posArray, numChannels, sizeZ, ...
    superres, experimentLabel, chaTformGlobal)
% outputs the ref points for each channel as a matlab figure and save the
% points using the roi to filter points in cells.
% implemented chromatic aberration correction step in the very beginning to the images.
% fiducial marker locations saved are already chromatically corrected.
    ...
    for position = chaTformArray
        ...
        [chaTformInitialAll{position+1}, refPointsAlignedInitial{position+1}, ...
            ...
            getrefbeadsfilter_v2(experimentDir, position, initFolderName, roimask, chaTformGlobal, ...
        ...
        [chaTformFinalAll{position+1}, refPointsAlignedFinal{position+1}, ...
            ...
            getrefbeadsfilter_v2(experimentDir, position, finalFolderName, roimask, chaTformGlobal, ...
