...
for channel in channels:
    ...
    #dal.auto_set_params()
    dal.set_xy_search_error(0.3)
    dal.set_z_search_error(0.5)
    dal.set_max_bright_prop(3)
    ...
    dal.set_max_z_offset(8) # 5 default
    dal.min_dot_matches = 10 # 4-10 for E14, 200-600 for brain, 50 for brain RNA FISH, manually switch.
    dal2 = deepcopy(dal)
    dal.set_n_longest_edges(400) # 100 for brain, 200-400 for E14
