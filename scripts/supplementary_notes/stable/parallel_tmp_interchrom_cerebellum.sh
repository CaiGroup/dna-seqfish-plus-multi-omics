...
#            bash cerebellum_interchrom_distance_pipeline.sh MLI1 /groups/CaiLab/personal/yujing/Yodai/100k/data/raw/MLI1/profile_per_dot/radial_organization /groups/CaiLab/personal/yujing/Yodai/100k/data/distance_final $comb $rep
             bash cerebellum_interchrom_distance_pipeline.sh MLI2_PLI /groups/CaiLab/personal/yujing/Yodai/100k/data/raw/MLI2_PLI/profile_per_dot/radial_organization /groups/CaiLab/personal/yujing/Yodai/100k/data/distance_final $comb $rep
