...
def main():
    ...
    # save
    print ("before norm dataframe save")
    ...
    #save the norm_df
    pd.to_pickle(norm_df, output_dir / f"{chrom}_{chrom}_rep{rep}_25kb.pkl")
...
if __name__ == "__main__":
    ...
    # temparory test
    dbscan_col =  "dbscan_ldp_nbr_allele"
    print (dbscan_col)
    # default values that stays constant
